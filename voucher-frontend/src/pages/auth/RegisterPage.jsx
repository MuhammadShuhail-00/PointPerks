...
/* ── Stagger hook: returns className when element enters viewport ── */
    ...
    <div className="pp-register-root">
          ...
          <aside className="pp-left">
            ...
            <div className="pp-features">
              <div className="pp-feature pp-anim" ref={sFeat1}>
                <span style={icon(22)}>verified_user</span>
          ...
          <div className="pp-form-wrap">
            <div className="pp-form-card pp-anim" ref={sCard}>
              ...
              <form onSubmit={handleSubmit} className="pp-form" noValidate>
                {/* Name */}
                <div className="pp-field pp-anim" ref={sName}>
                  <label htmlFor="reg-name" className="pp-label">
                    Full Name
                  </label>
                ...
                <div className="pp-field pp-anim" ref={sEmail}>
                  <label htmlFor="reg-email" className="pp-label">
                    Email Address
                  </label>
                  <div className="pp-input-wrap">
                    <span className="pp-input-icon" style={icon(20)}>
                ...
                <div className="pp-field pp-anim" ref={sPw}>
                  <label htmlFor="reg-pw" className="pp-label">
                    Password
                  </label>
                  <div className="pp-input-wrap">
                    <span className="pp-input-icon" style={icon(20)}>
                ...
                {/* Referral */}
                <div className="pp-field pp-anim" ref={sRef}>
                  <label htmlFor="reg-ref" className="pp-label">
                    Referral Code{' '}
                    <span className="pp-label__optional">(optional)</span>
                  </label>
                  <div className="pp-input-wrap">
                    <span className="pp-input-icon" style={icon(20)}>
                      redeem
                    ...
                    />
                    {checkingRef && (
                      <span className="pp-ref-spinner" style={icon(20, 1)}>
                        progress_activity
                      </span>
                    )}
                  </div>
                  ...
                  {!checkingRef &&
                    form.referralCode.trim().length >= 6 &&
                    !referrerInfo?.valid && (
                ...
                <div className="pp-anim" ref={sGoogle}>
                  <button type="button" className="pp-btn pp-btn--google" onClick={() => authAPI.googleLogin(form.referralCode.trim() || null)}>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Staggered entrance (default hidden state) */
        .pp-anim {
          opacity: 0;
        ...
        /* Left column slides from left instead */
        ...
        /* Hint fade-in */
        .pp-hint--enter {
          animation: pp-fadeUp 0.3s cubic-bezier(0.22, 1, 0.36, 1) both;
        }
        @keyframes pp-fadeUp {
        ...
        /* Referral check spinner */
        .pp-ref-spinner {
          animation: pp-spin 1s linear infinite;
        }

        /* Mobile bonus gentle breathe */
        .pp-mobile-bonus {
        ...
        /* Feature cards stagger highlight on desktop */
        @media (min-width: 1024px) {
        ...
        .pp-login-link a:hover { opacity: 0.8; }
